...
const UploadPage: React.FC = () => {
	// Case ID is auto-generated by backend; remove manual input
		...
		<div style={{ minHeight: '100vh', background: '#f7f7f9' }}>
			<div style={{ maxWidth: 860, margin: '0 auto', padding: '24px 16px' }}>
				...
				<form onSubmit={onSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 16 }}>
					...
					{/* Case ID input removed — backend will auto-generate case IDs */}
					...
					<div style={card}>
						...
						<div style={{ display: 'flex', gap: 8, marginTop: 12 }}>
							...
							<button type="button" style={secondaryBtn} onClick={() => { setProductImages(null); setIssueDescription(''); setMessage(''); }}>Reset</button>
						</div>
						{message && (
